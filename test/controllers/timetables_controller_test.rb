...
class TimetablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timetable" do
    assert_difference('Timetable.count') do
      post timetables_url, params: { timetable: { from: @timetable.from, name: @timetable.name, to: @timetable.to } }
    end
  ...
  test "should update timetable" do
    patch timetable_url(@timetable), params: { timetable: { from: @timetable.from, name: @timetable.name, to: @timetable.to } }
